...
const variantClasses = {
	...
	danger: 'bg-gradient-to-br from-red-500 to-red-700 text-white shadow-md hover:scale-[1.015] disabled:from-neutral-400 disabled:to-neutral-400 disabled:shadow-none disabled:scale-100',
