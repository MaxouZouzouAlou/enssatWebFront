...
import { getProductImageValue, resolveProductImageUrl } from '../../utils/productMedia.js';
import {
...
export default function ProductCard({ product, onAdd = () => {}, onOpenProduct = null }) {
  ...
  const image = resolveProductImageUrl(getProductImageValue(product));
        ...
        <div className="flex items-end justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            <ActionButton
              ...
              onClick={async (event) => {
					event.stopPropagation();
	                try { await onAdd(product, cartQuantity); } catch {}
              }}
              onKeyDown={(event) => {
                event.stopPropagation();
              }}
